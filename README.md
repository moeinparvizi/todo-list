...
a simple todo list build with js and 2 project more just for practices js , happy me with star and follow:)
e1 folder is some boxes when cklick on box tell today 
e2 folder a trick like tab changer bootstrap
...
| Color             | Hex                                                                |
| ----------------- | ------------------------------------------------------------------ |
| Primary Color |  grandient color for background of todolist box|
